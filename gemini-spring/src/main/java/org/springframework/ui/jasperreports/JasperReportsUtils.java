...
public abstract class JasperReportsUtils {
	...
	/**
	 * @see #render(net.sf.jasperreports.engine.JRExporter, net.sf.jasperreports.engine.JasperPrint, Writer)
	...
	/**
	 * @see #render(net.sf.jasperreports.engine.JRExporter, net.sf.jasperreports.engine.JasperPrint, OutputStream)
	 * @deprecated in favor of the <code>render</render> version with JRExporter parameter
	 */
